  ...
  async function getListings(url, data) {
    try {
      ...
      for (let i = 0; i < listingData.length; i++) {
        ...
        /* The styling of these elements are not consistent as the placeholders are to small to fit the information needed so a decision has to be made as to how big the listings should be */
